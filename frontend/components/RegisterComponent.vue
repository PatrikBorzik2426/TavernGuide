<template>
    ...
    <form @submit.prevent="validateForm" class=" flex flex-col w-6/12 h-fit text-white border-4 rounded-2xl border-purple p-8 animate-fade-left">
        ...
        <div class=" flex flex-col gap-y-4 w-full">
            ...
            <div class=" w-full flex flex-col">
                ...
                <input v-model="email" type="text" name="email" class=" my-2 px-2 py-1 h-10 bg-transparent border-[3px] border-purple rounded-md">
