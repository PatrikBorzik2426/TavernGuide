      ...
      <div class=" gap-2 w-full h-full max-w-[100vw] bg-dark overflow-auto scrollbar-thin scrollbar-track-transparent scrollbar-thumb-purple">  
        <div class="flex flex-col max-w-fit gap-y-2 fixed top-[20%] left-[90%] mb-4 justify-center z-20">
          ...
          <label class="inline-flex items-center cursor-pointer">
              ...
              <div class="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4  rounded-full peer dark:bg-light_purple peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:border after:rounded-full after:h-5 after:w-5 after:transition-all  peer-checked:bg-purple"></div>
